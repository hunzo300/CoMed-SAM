...
from script.Chaos.train.train import CoMedSAM, NpyDataset

device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
batch_size = 1
num_workers = 8
dataset_path = "/CoMed-sam_dataset/Chaos/Chaos_npy_test_dataset_1024image"
csv_file_path = "/output_csv/CoMed-SAM/phase_count_1.csv"
